...
model.load_state_dict(torch.load("mnist/badnet_mnist.pth"))
model.train()
...
if os.path.exists("mnist/badnet_finetuned.pth"):
    model.load_state_dict(torch.load("mnist/badnet_finetuned.pth"))
else:
    ...
    # 保存fine-tuning后的模型
    torch.save(model.state_dict(), "mnist/badnet_finetuned.pth")
